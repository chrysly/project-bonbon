...
namespace ModelAssetDatabase {
        ...
        public static string ConfigPath {
            get {
                var assetGUID = AssetDatabase.FindAssets($"t:Script {nameof(ConfigurationCore)}");
        ...
        public static MADAssets ToolAssets {
            get {
                var assetGUID = AssetDatabase.FindAssets($"t:{nameof(MADAssets)} {nameof(MADAssets)}");
                return AssetDatabase.LoadAssetAtPath<MADAssets>(AssetDatabase.GUIDToAssetPath(assetGUID[0]));
            }
        }
