...
public class ModelAssetLibraryModalPrefabDeletion : EditorWindow {
    ...
    public static bool ConfirmPrefabDeletion(string prefabName) {
        fileName = prefabName;
        var window = GetWindow<ModelAssetLibraryModalPrefabDeletion>("Prefab Variant Deletion");
...
public class ModelAssetLibraryModalMaterialChanges : EditorWindow {
    ...
    public static bool ConfirmMaterialChanges() {
        var window = GetWindow<ModelAssetLibraryModalMaterialChanges>("Unapplied Material Changes");
