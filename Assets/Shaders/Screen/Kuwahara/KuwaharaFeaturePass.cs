...
public class KuwaharaFeaturePass : ScriptableRenderPass
{
    ...
    public KuwaharaFeaturePass(Material structureTensorMaterial) {
    ...
    public void Setup(KuwaharaRenderFeature.Settings settings)
    {
        SetupKuwaharaFilter(settings.kuwaharaFilterSettings);
        SetupLineIntegralConvolution(settings.edgeFlowSettings);
        SetupCompositor(settings.compositorSettings);
    }
    
    private void SetupKuwaharaFilter(KuwaharaRenderFeature.KuwaharaFilterSettings kuwaharaFilterSettings)
    {
    ...
    private void SetupCompositor(KuwaharaRenderFeature.CompositorSettings compositorSettings)
    {
    ...
    private void SetupLineIntegralConvolution(KuwaharaRenderFeature.EdgeFlowSettings edgeFlowSettings)
    {
